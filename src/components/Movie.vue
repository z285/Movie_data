<template>
 ...
 <div class="card-deck">
  <div class="card" v-for="(data) in movie_list" :key="data">
<div class="hvrbox">
...
export default {
    ...
    methods:{  
        Get_Start : function(page){
          this.axios.get("https://api.themoviedb.org/3/search/movie?api_key=7a884526e4e67695d33cd2c16acbfccc&query=a&page="+page).then((response) => {
